...
class BackupController extends Controller
{
    public function create()
    {
        try {
            ...
            $backupPath = getenv('USERPROFILE') . '\Desktop\backups';
            ...
            return redirect()->back()->with('success', 'تم إنشاء النسخة الاحتياطية بنجاح في المسار: ' . $backupPath . '\\' . $filename . ' (حجم الملف: ' . number_format($fileSize / 1024, 2) . ' KB)');
        } catch (\Exception $e) {
